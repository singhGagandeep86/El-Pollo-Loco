...
function createBackgroundObjects() {
    return [
        new BackgroundObject('img/5_background/layers/air.png', -717),
        new BackgroundObject('img/5_background/layers/3_third_layer/1.png', -717),
        new BackgroundObject('img/5_background/layers/2_second_layer/1.png', -717),
        new BackgroundObject('img/5_background/layers/1_first_layer/1.png', -717),
        ...
        new BackgroundObject('img/5_background/layers/3_third_layer/2.png', 717 * 2),
        new BackgroundObject('img/5_background/layers/2_second_layer/2.png', 717 * 2),
        new BackgroundObject('img/5_background/layers/1_first_layer/2.png', 717 * 2),
        new BackgroundObject('img/5_background/layers/air.png', 717 * 3),
        new BackgroundObject('img/5_background/layers/3_third_layer/1.png', 717 * 3),
        new BackgroundObject('img/5_background/layers/2_second_layer/1.png', 717 * 3),
        new BackgroundObject('img/5_background/layers/1_first_layer/1.png', 717 * 3),
        new BackgroundObject('img/5_background/layers/air.png', 717 * 4),
        new BackgroundObject('img/5_background/layers/3_third_layer/2.png', 717 * 4),
        new BackgroundObject('img/5_background/layers/2_second_layer/2.png', 717 * 4),
        new BackgroundObject('img/5_background/layers/1_first_layer/2.png', 717 * 4),
        new BackgroundObject('img/5_background/layers/air.png', 717 * 5),
        new BackgroundObject('img/5_background/layers/3_third_layer/1.png', 717 * 5),
        new BackgroundObject('img/5_background/layers/2_second_layer/1.png', 717 * 5),
        new BackgroundObject('img/5_background/layers/1_first_layer/1.png', 717 * 5)
    ]
}
