...
class World {
    ...
    /** 
     * Clears the entire canvas. This method is used at the beginning of every draw cycle to erase the previous frame. 
     */
    clearCanvas() {
    ...
    /** 
     * Reverses the effects of calling flipImage on the given MoveableObject, 
     * restoring the canvas context to its original state.
